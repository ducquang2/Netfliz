...
module.exports = {
  ...
  registerUser: async (req, res, next) => {
    try {
      ...
      <a style="background: #CD0574;min-width: 300px;border-radius: 12.8px;padding: 25.5px 19px 26.5px 19px;text-align: center;font-size: 18px;font-weight: 700;color: #f9f9f9;display: inline-block;text-decoration: none;line-height: 120%;}" href="https://netflizserver.onrender.com/users/authenMail/${token}">XÁC MINH EMAIL</a>
      </div>
      </td>
      </tr>
      </tbody>
